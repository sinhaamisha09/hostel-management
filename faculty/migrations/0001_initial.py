# Generated by Django 2.2.11 on 2020-06-18 03:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ManyToManyField(blank=True, default=None, to='faculty.Course')),
            ],
        ),
        migrations.CreateModel(
            name='Room',
            fields=[
                ...
                ('hostel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='faculty.Hostel')),
            ],
        ),
        migrations.CreateModel(
            name='Student',
            fields=[
                ...
                ('course', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='faculty.Course')),
                ('room', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='faculty.Room')),
